...
<?php 
     ...
     if (isset($_POST['vugurura'])) {
      ...
      $password = $_POST['password']; 
        ...
        $sql="UPDATE umuryango SET `um_name`='$umuryango', umurenge='$umurenge', username='$username', `password`='$password' where `um_id`='$id'";
...
if ($_GET['id']) {  
    $id = $_GET['id'];  
        $sql = "DELETE FROM `umuryango` WHERE `um_id` = '$id'";  
...
<body>
    ...
    <div class="sidebar">
        ...
        <ul>
                ...
                <li><a  style=" text-decoration: none;"  href="abanyamuryango.php"><span><i  style="margin:0 .1rem; padding:0 1.4rem; " class="fas fa-archive"></i>Abanyamuryango</span></a></li>
                <li><a  style=" text-decoration: none;"  class="active"  href="imihigo.php"><span><i  style="margin:0 .1rem; padding:0 1.4rem; " class="fas fa-book-reader"></i>Imihigo</span></a></li>
    ...
    <div class="main-content">
        ...
        <div class="main">
            ...
            <h5>Imigigo Yahiguwe Muri Rusange</h5>
            <hr>
            <div class="search">
                    <h6><?php echo $msg; ?></h6>
                    <button type="button" class="btn btn-primary" onclick="document.getElementById('signin').style.display='block'; "></ion-icon>&nbsp; + Higa</button>
                    </div>
            ...
            <div class="tablet">
                <table class="table table-bordered table-striped">
                    ...
                    <th colspan="4">Ibikorwa</th>
                              ...
                              <?php 
                                $sql = mysqli_query($con, "SELECT * FROM imihigo");
                                while($row = mysqli_fetch_assoc($sql)){
                                ?>
                <tr>
                 
                    <td><?php echo $row['im_name']; ?></td>
                    <td><?php echo $row['um_id']; ?></td>
                    <td><?php echo $row['ab_name']; ?></td>
                    <td><?php echo $row['status']; ?></td>
                    <td><?php echo $row['Igihe']; ?></td>
                    <td><a  onclick="return confirmation();" style="color:red;" href="imiryango.php?id=<?php echo $row['um_id'];?>"><svg color="red" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash-fill" viewBox="0 0 16 16">
                        <path d="M2.5 1a1 1 0 0 0-1 1v1a1 1 0 0 0 1 1H3v9a2 2 0 0 0 2 2h6a2 2 0 0 0 2-2V4h.5a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1H10a1 1 0 0 0-1-1H7a1 1 0 0 0-1 1H2.5zm3 4a.5.5 0 0 1 .5.5v7a.5.5 0 0 1-1 0v-7a.5.5 0 0 1 .5-.5zM8 5a.5.5 0 0 1 .5.5v7a.5.5 0 0 1-1 0v-7A.5.5 0 0 1 8 5zm3 .5v7a.5.5 0 0 1-1 0v-7a.5.5 0 0 1 1 0z"/>
                      </svg></a></td>
                    <td><a href="imiryango.php?id1=<?php echo $row['um_id'];?>"  onclick="document.getElementById('exampleModal1').style.dispaly='display'"><svg color="#0d6efd" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-fill" viewBox="0 0 16 16">
                ...
                <?php
                                    ...
                                    $sql=mysqli_query($con,"SELECT * FROM umuryango where um_id='$edit' ");
                  ...
                  <div class="mb-3">
                    <label for="exampleDropdownFormEmail1" class="form-label">Umuryango wa:</label>
                    <input type="text" name="umuryango" class="form-control" id="exampleDropdownFormEmail1" value="<?php echo $row['um_name']; ?>" required>
                  </div>
                  <div class="mb-3">
                    <label for="exampleDropdownFormEmail1" class="form-label">Umerenge</label>
                    <input type="text" name="umurenge" class="form-control" id="exampleDropdownFormEmail1" value="<?php echo $row['umurenge']; ?>" required>
                  </div>
                  <div class="mb-3">
                  <div class="mb-3">
                    <label for="exampleDropdownFormEmail1" class="form-label">Amazina</label>
                    <input type="text" name="username" class="form-control" id="exampleDropdownFormEmail1"value="<?php echo $row['username']; ?>" required>
                  </div>
                    <label for="exampleDropdownFormPassword1" class="form-label">Ijambobanga</label>
