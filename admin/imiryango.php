...
<body>
    ...
    <div class="sidebar">
        ...
        <ul>
                ...
                <li><a  style=" text-decoration: none;"  class="active" href="imiryango.php"><span><i  style="margin:0 .1rem; padding:0 1.4rem; " class="fas fa-archive"></i>Imiryango</span></a></li>
    ...
    <div class="main-content">
        ...
        <div class="main">
            ...
            <div class="search">
                    <h6><?php echo $msg; ?></h6>
                    <button type="button" class="btn btn-primary" onclick="document.getElementById('signin').style.display='block'; "></ion-icon>&nbsp; + Umuryango</button>
                    </div>
            ...
            <div class="tablet">
                <table class="table table-bordered table-striped">
                    ...
                    <th colspan="4">Ibikorwa</th>
                              ...
                              <?php 
                                $sql = mysqli_query($con, "SELECT * FROM umuryango");
                                while($row = mysqli_fetch_assoc($sql)){
                                ?>
                <tr>
                    <td><?php echo $row['um_id']; ?></td>
                    <td><?php echo $row['um_name']; ?></td>
                    <td><?php echo $row['umurenge']; ?></td>
